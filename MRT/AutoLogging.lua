...
function module.options:Load()
	...
	self.classic5pplHC = ELib:Check(self,L.LoggingClassic5pplHC,VMRT.Logging.classic5pplHC):Point("TOP", self.arena,"BOTTOM",0,-5):Point("LEFT",self,15,0):OnClick(function(self)
		if self:GetChecked() then
	...
	self.classic5pplNormal = ELib:Check(self,L.LoggingClassic5pplNormal,VMRT.Logging.enableclassic5pplNormal):Point("TOP", self.classic5pplHC,"BOTTOM",0,-5):Point("LEFT",self,15,0):OnClick(function(self)
		if self:GetChecked() then
