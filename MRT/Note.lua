...
function module.options:Load()
	...
	self.rosterpickdd = ELib:DropDown(self.tab.tabs[1],170,-1):Point("LEFT",self.dropDownColor,"RIGHT",5,0):Size(150):SetText(L.RosterSelect)
	...
	module.options.rosteredit = ELib:Popup(L.RosterEditPopupTitle):Size(600,600):OnShow(function(self) self:Update() end,true)
