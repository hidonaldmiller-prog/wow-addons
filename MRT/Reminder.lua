...
function options:Load()
	...
	self.tab = ELib:Tabs(self,0,L.ReminderGlobal,L.ReminderPersonal,L.minimapmenuset,L.ReminderTabTimeline,L.ReminderTabAssignments):Point(0,-45):Size(698,570):SetTo(1):ChangeTabPos({1,2,4,5,3})
	...
	options.assign.frame.quick.dd = ELib:DropDown(options.assign.frame.quick,250,-1):Point("BOTTOM",options.assign.frame.quick.filter,"TOP",0,5):Size(220):SetText(L.RosterSelect):OnShow(function() options.assign:PlayerListUpdateOnShow() end,true)
	...
	options.assign.frame.quick.rosteredit = ELib:Popup(L.RosterEditPopupTitle):Size(600,600):OnShow(function(self) self:Update() end,true)
	...
	self.optIconSizeCustom = ELib:Check(self.optionWidgets.tabs[1],L.ReminderOptIconSizeCustom,VMRT.Reminder2.IconSizeCustom):Point("TOPLEFT",self.optGrowUp,"BOTTOMLEFT",0,-5):Left(5):OnClick(function(self) 
	...
	self.chkSyncOnlyPersonal = ELib:Check(self.options_tab.tabs[1],L.ReminderSyncOnlyPersonal,VMRT.Reminder2.SyncOnlyPersonal):Point("TOPLEFT",self.chkHistorySync,"BOTTOMLEFT",0,-50):Left(5):OnClick(function(self) 
		if self:GetChecked() then
			VMRT.Reminder2.SyncOnlyPersonal = true
		else
			VMRT.Reminder2.SyncOnlyPersonal = nil
		end
	end):Tooltip(L.ReminderSyncOnlyPersonalTooltip)
