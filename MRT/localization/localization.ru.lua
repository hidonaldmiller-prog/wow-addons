...
L.LoggingClassic5pplHC = "Подземелье на 5 игроков (героическое)"
L.LoggingClassic5pplNormal = "Подземелье на 5 игроков (обычное)"

L.RosterSelect = "Выбор состава"
L.RosterCurrent = "Текущий состав"
L.RosterGuild = "Гильдия"
L.RosterAllClasses = "Все классы"
L.RosterCustom = "Пользовательский состав"
L.RosterEdit = "Изменить"
L.RosterEditPopupTitle = "Редактировать пользовательский состав"
...
L.InterruptsFromNoteMultiTooltip = "Импортировать прерывания для нескольких NPC/заклинаний из заметки.\nПоддерживается только новый формат с intstart – intend."
...
L.ReminderTabTimeline = "Таймлайн"
L.ReminderTabAssignments = "Назначения"
L.ReminderOptIconSizeCustom = "Пользовательский размер иконок в тексте:"
...
L.ReminderSyncOnlyPersonal = "«Отправка» только личных напоминаний:"
L.ReminderSyncOnlyPersonalTooltip = "При синхронизации будут отправляться только ваши личные напоминания.\nОбщие напоминания у получателей не удаляются."
